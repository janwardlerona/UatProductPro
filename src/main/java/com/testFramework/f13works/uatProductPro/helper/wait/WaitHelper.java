package com.testFramework.f13works.uatProductPro.helper.wait;
...
public class WaitHelper {
	...
	public void setImplicitlyWait(long timeout, TimeUnit unit) {
		log.info("ImplicitlyWait has been set to: " +timeout);
	 ...
	 * @param timeOutInSeconds
	 */
	public void frameToBeAvailableAndSwitchToIt(WebElement element,long timeOutInSeconds ){
		log.info("waiting for : "+element.toString()+" for : "+ timeOutInSeconds+" seconds");
		WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
	...
	public void pageLoadTime(long timeout, TimeUnit unit){
		log.info("wating for page to load: "+ unit+ " seconds");
